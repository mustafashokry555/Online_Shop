...
if(empty($category['name']))
	$category['name'] = 'Categorie Not Found';

$productsOfCat = $pr->selectwhere("cat_id = $id", 'id, name, price, img');
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						...
						<div class="product_grid">
							...
							<?php foreach($productsOfCat as $product):?>
							<!-- Product Item -->
